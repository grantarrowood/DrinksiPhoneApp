...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *userPool = [defaults stringForKey:@"userPool"];
    if ([userPool isEqualToString:@"CUSTOMER"]) {
        cell.textLabel.text = [(Orders *)[ordersArray objectAtIndex:indexPath.row] Location];
        cell.detailTextLabel.text = [(Orders *)[ordersArray objectAtIndex:indexPath.row] driverUsername];
    } else {
